...
const Footer = () => {
  return (
    <div className='rounded-2xl mt-8 pt-8 text-primary border-t-2'>
            ...
            <div className='flex justify-evenly w-full md:max-w-[300px] uppercase'>
                <div>
                    ...
                    <ul>
                        ...
                        <li className='text-sm py-2'>API Center</li>
                        <li className='text-sm py-2'>Docuementation</li>
                    </ul>
                </div>
                <div>
            ...
            <div className='text-right'>
                <div className='w-full flex justify-end '>
                    <div className='w-full md:w-[300px] py-4 relative'>
                        <div className='flex justify-end md:justify-end py-4 md:py-0 md:pb-4 mt-[-1rem]'>
                            <ThemeToggle />
                        </div>
