...
return (
    ...
    <div className='rounded-div shadow-md flex items-center justify-between h-20 font-bold '>
        <Link to='/'> 
        <div className='text-2xl'>Cryptobase</div>
        </Link>
        ...
        <div className={nav ? 'md:hidden fixed left-0 top-20 flex flex-col items-center justify-between w-full h-[90%] bg-primary ease-in duration-300 z-10' : 'fixed left-[-100%] top-20 h-[90%]  flex flex-col items-center justify-between easin-in duration-300'}>
            {/* Mobile Menu */}
